...
Il progetto dimostra inoltre un utilizzo coerente degli strumenti di sviluppo moderni: containerizzazione con Docker, gestione delle dipendenze tramite npm, build riproducibili e controllo di versione distribuito con Git e GitHub, con una storia di commit che copre l'intero ciclo di vita del progetto.
