...
\section{Istruzioni di esecuzione dei test}
Per eseguire la suite xUnit backend:
...
\section{Artefatti principali consultati}
\begin{itemize}
  \item \texttt{dietiestates-backend/test/backend.test.ts}
  \item \texttt{dietiestates-backend/jest.config.ts}
  \item \texttt{dietiestates-backend/package.json}
...
in P. W. Jordan et al. (eds.), Usability Evaluation in Industry, Taylor \& Francis, 1996.
\end{thebibliography}
